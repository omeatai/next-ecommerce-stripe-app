    ...
    <div className="p-8">
      <div className="max-w-4xl text-justify my-4">
        ...
        <h3>
          ...
          innovation. Our passion for delivering top-notch gadgets is reflected
          in our commitment to providing our customers with the latest and
          greatest in the world of technology.
        </h3>
      </div>
